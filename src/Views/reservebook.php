                    ...
                    <div class="col-md-7">
                        ...
                        <div>
                            ...
                            <div class="rules-box small">
                                <p><i class="bi bi-exclamation-diamond-fill text1 me-2"></i> <strong class="text1"> Loan
                                        Period :</strong> <span class="text2"> Must return within 2 weeks (14
                                        days).</span></p>

                                <p><i class="bi bi-exclamation-diamond-fill text1 me-2"></i> <strong
                                        class="text1">Overdue Fine :</strong>
                                    <span class="text2"> After 2 weeks, a fine of
                                        <strong>$<?php echo number_format($fineamount, 2); ?></strong>
                                        (<?php echo $dailyrate; ?>%) will be added <span class="ms-4"> daily until
                                            returned.</span></span>
                                </p>

                                <p><i class="bi bi-exclamation-diamond-fill text1 me-2"></i><strong class="text1">
                                        Damage Policy :</strong>
                                    <span class="text2"> If the book is damaged, you must inform the <span class="ms-4">
                                            librarian and pay the full value of
                                            <strong>$<?php echo number_format($bookprice, 2); ?></strong>.</span></span>
                                </p>
                        ...
                        <div class="form-check mt-4">
                            ...
                            <label class="form-check-label fw-bold text1" for="ruleCheck">I agree to the library rules
                    ...
                    <div class="col-md-5 text-center d-flex flex-column justify-content-between">
                        <div>
                            <?php if (!empty($coverimg)): ?>
                                <img src="data:image/jpeg;base64,<?php echo base64_encode($coverimg); ?>"
                                    class="img-fluid  shadow-sm mb-4" style="max-height: 350px;"
                                    alt="<?php echo htmlspecialchars($bookname); ?>">
                            <?php else: ?>
                                <div class="p-5 bg-light border rounded">No Cover Image</div>
                            <?php endif; ?>
                        </div>
